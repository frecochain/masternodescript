...
4. Send 10000 FRECO to this address and wait for at least 1 confirmation
...
```
bash <( curl -sL https://raw.githubusercontent.com/frecochain/masternodescript/main/install.sh)
```
...
```<alias> <ip>:8282 <private_key> <tx_id> <index>```
3. It should look something like this:
``` MN1 127.0.0.2:8282 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX X```
